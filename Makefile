...
_DEPS = deps.h utils.h window/*.hpp nuklear/*.h shaders/vulkan/*.hpp nuklear/nuklear.h stb/stb_image.h shaders/shader2.h glm/glm.hpp glmm/gtc/matrix_transform.hpp glm/gtc/type_ptr.hpp
